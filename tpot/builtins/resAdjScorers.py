...
and adjY columns as generated by the resAdjTpotPreprocessor script.
"""
...
def resAdjMseScorer(estimator, X, y):
    ...
    y : array-like
    Gold standard target values for X. They WILL NOT BE USED THOUGH,
    values in the appropriate adjY will be used instead.
