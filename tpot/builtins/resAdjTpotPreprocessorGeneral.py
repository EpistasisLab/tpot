...
6. Estimator to be used, as a quoted string, including all parameter settings in parentheses. # GEN
...
mode = sys.argv[5]
myEst = sys.argv[6] # GEN
numSplits = int(sys.argv[7])
outTrainFile = sys.argv[8]
outTestFile = sys.argv[9]
cov = sys.argv[10].split(',')
...
if mode == 'classification': # GEN
        ...
        from sklearn.linear_model import ElasticNetCV, LinearRegression, LassoLarsCV, RidgeCV, SGDRegressor
