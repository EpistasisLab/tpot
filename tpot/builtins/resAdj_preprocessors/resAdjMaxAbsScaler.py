...
SCOPE
Modification of MaxAbsScaler which handles indicator and adjY columns.
"""
...
class resAdjMaxAbsScaler(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y=None, **fit_params):
        ...
        est = MaxAbsScaler(copy=self.copy)
