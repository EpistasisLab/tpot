...
SCOPE
Modification of StandardScaler which handles indicator and adjY columns.
"""
...
class resAdjStandardScaler(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y=None, **fit_params):
        ...
        est = StandardScaler(copy=self.copy)
