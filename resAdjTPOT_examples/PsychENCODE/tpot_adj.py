...
Xtrain = pd.read_csv(inTrainFile, sep='\t', index_col='eid')
Ytrain = Xtrain['adjY']
Xtrain.drop(['adjY'], axis=1,  inplace=True)
Xtest = pd.read_csv(inTestFile, sep='\t', index_col='eid')
Ytest = Xtest['adjY']
